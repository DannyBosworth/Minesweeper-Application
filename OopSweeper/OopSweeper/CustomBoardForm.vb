Public Class CustomBoardForm
    ...
    Private Sub GenerateBoard() Handles GenerateBoardButton.Click
        ...
        SolvedBoardBox.Show()
        Img = False
        FlagWarningLabel.Text = ""
    End Sub

    Sub DisplaySolvedBoard(Board As Bitmap)
        FlagWarningLabel.Text = "WARNING - May not be correct if flags have been used" & vbNewLine & "or if impossible cells are present"
        SafeLabel.Text = "Safe"
    ...
    Private Sub ResizeForm()
        ...
        Size = New Size(UserOptionsBox.Location.X + UserOptionsBox.Width + 10, Math.Max(UserOptionsBox.Height + 43, SolvedBoardBox.Height + 43))
        SolvedBoardBox.Location = New Point(0, (Size.Height - 43 - SolvedBoardBox.Height) / 2)
