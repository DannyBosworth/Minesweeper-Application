        ...
        Sub SolveBoard()
            ...
            Do
                ...
                For Each Cell In Cells
                    ...
                    End If
                Next
                myConstraintSolver = New ConstraintSolver(Cells, DeepClone(SafeCells), True)
                myConstraintSolver.FindNonTrivialSolutions()
                If myConstraintSolver.GetSafeCells Is Nothing Then Solved = Nothing : Exit Sub
                For Each SafeCell In myConstraintSolver.GetSafeCells
                    If SafeCells.Find(Function(x) x.GetIndex = SafeCell.GetIndex) Is Nothing Then SafeCells.Add(SafeCell)
                Next
